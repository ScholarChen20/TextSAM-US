...
--seg_path ${OUTPUT}/${DATASET}/seg_results/seed${SEED}/${text}/LORA${RANK}_SHOTS-1_NCTX${CTX}_CSCFalse_CTPend \
--save_path ${OUTPUT}/${DATASET}/seg_results/seed${SEED}/${text}/test.csv